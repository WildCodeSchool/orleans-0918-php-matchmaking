 ...
 */
final class Version20181125144807 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE format_event (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, number_of_tables INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE round_event (id INT AUTO_INCREMENT NOT NULL, format_event_id INT NOT NULL, table_event_id INT NOT NULL, speech_round INT NOT NULL, user_speech INT NOT NULL, INDEX IDX_EDDD1E5ED6CDD85F (format_event_id), INDEX IDX_EDDD1E5EE14AC65B (table_event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
